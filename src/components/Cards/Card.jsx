...
const Card = () => {
  return (
    <div data-scroll data-scroll-speed="0.5"  className="w-full min-h-screen px-4 md:px-14 pb-40 md:pb-0 flex items-center justify-center  ">
    <div  className="w-full h-full md:h-[90vh] lg:h-[50vh] flex flex-col lg:flex-row items-center gap-5">
            <div id="sticky-target" className="cardContainer w-full h-[60vw] md:h-full  md:w-full  rounded-lg relative flex items-center justify-center bg-[#004D43]">
            ...
            <div id="sticky-target" className="cardcontainer w-full h-full flex flex-col md:flex-row items-center gap-5">
